...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("org-synopsys-sdc bounded-duty-cycle Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("org-synopsys-sdc Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("org-synopsys-sdc Wasm main mismatch");

console.log("org-synopsys-sdc: bounded duty-cycle Web/Wasm conformance passed");
